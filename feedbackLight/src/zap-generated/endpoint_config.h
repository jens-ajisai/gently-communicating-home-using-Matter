...
\
  /* Endpoint: 1, Cluster: Level Control (server) */ \
  { ZAP_SIMPLE_DEFAULT(0x01), 0x00000000, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* CurrentLevel */  \
  ...
  { ZAP_SIMPLE_DEFAULT(50), 0x00000014, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* DefaultMoveRate */  \
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x00), 0x00000008, 1, ZAP_TYPE(ENUM8), 0 }, /* ColorMode */  \
  { ZAP_SIMPLE_DEFAULT(0x00), 0x0000000F, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* Options */  \
  { ZAP_SIMPLE_DEFAULT(0x00), 0x00004001, 1, ZAP_TYPE(ENUM8), 0 }, /* EnhancedColorMode */  \
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x010C,1}}
